...
internal class FindLogsQueryHandler @Inject constructor(
    private val finder: LogsFinder
) : QueryHandler<FindLogsQuery, Logs?> {

    override fun handle(query: FindLogsQuery): Flow<Logs?> = finder.find()
