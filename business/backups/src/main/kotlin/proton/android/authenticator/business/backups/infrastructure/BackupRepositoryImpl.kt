...
package proton.android.authenticator.business.backups.infrastructure
...
internal class BackupRepositoryImpl @Inject constructor(
    private val localDataSource: PreferencesDataSource<Backup>
) : BackupRepository {

    override fun find(): Flow<Backup> = localDataSource.observe()

    override suspend fun save(backup: Backup) {
        localDataSource.update(backup)
    }
