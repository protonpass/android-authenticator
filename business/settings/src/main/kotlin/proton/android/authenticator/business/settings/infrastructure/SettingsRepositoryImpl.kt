...
package proton.android.authenticator.business.settings.infrastructure
...
internal class SettingsRepositoryImpl @Inject constructor(
    private val localDataSource: PreferencesDataSource<Settings>
) : SettingsRepository {

    override fun find(): Flow<Settings> = localDataSource.observe()

    override suspend fun save(settings: Settings) {
        localDataSource.update(settings)
    }
