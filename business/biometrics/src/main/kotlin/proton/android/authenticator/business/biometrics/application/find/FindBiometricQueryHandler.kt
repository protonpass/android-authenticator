...
internal class FindBiometricQueryHandler @Inject constructor(
    private val finder: BiometricFinder
) : QueryHandler<FindBiometricQuery, Biometric> {

    override fun handle(query: FindBiometricQuery): Flow<Biometric> = finder.find()
