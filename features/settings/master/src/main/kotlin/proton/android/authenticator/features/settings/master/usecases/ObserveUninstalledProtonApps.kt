...
internal class ObserveUninstalledProtonApps @Inject constructor(private val queryBus: QueryBus) {

    internal operator fun invoke(): Flow<List<ProtonApp>> = queryBus
        .ask<List<ProtonApp>>(FindAllProtonAppsQuery)
        .map { protonApps ->
            protonApps
                .filterNot(ProtonApp::isInstalled)
                .sortedBy(ProtonApp::position)
        }
