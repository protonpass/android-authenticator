...
import proton.android.authenticator.features.imports.permissions.R
...
@Composable
internal fun ImportsPermissionsContent(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    ...
                    text = stringResource(id = R.string.imports_permissions_title),
                ...
                Text(
                    ...
                    text = stringResource(id = R.string.imports_permissions_description),
                    textAlign = TextAlign.Center,
            ...
            VerticalActionsButtons(
                ...
                primaryActionText = stringResource(id = R.string.imports_permissions_action_primary),
                onPrimaryActionClick = onOpenAppSettingsClick,
                secondaryActionText = stringResource(id = R.string.imports_permissions_action_secondary),
                onSecondaryActionClick = onImportFromGalleryClick
            )
        }
    }
}
