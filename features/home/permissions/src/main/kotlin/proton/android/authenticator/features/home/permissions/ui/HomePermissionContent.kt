...
import proton.android.authenticator.features.home.permissions.R
...
@Composable
internal fun HomePermissionContent(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    ...
                    text = stringResource(id = R.string.home_permissions_title),
                ...
                Text(
                    ...
                    text = stringResource(id = R.string.home_permissions_description),
                    textAlign = TextAlign.Center,
            ...
            VerticalActionsButtons(
                ...
                primaryActionText = stringResource(id = R.string.home_permissions_action_primary),
                onPrimaryActionClick = onOpenAppSettingsClick,
                secondaryActionText = stringResource(id = R.string.home_permissions_action_secondary),
                onSecondaryActionClick = onCreateManuallyClick
            )
        }
    }
}
