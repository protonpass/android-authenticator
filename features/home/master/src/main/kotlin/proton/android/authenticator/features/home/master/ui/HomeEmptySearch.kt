...
@Composable
internal fun HomeEmptySearch(modifier: Modifier = Modifier) {
    Box(
        modifier = modifier,
        contentAlignment = Alignment.Center
    ) {
        Column(
            modifier = Modifier.padding(horizontal = ThemeSpacing.Large),
            ...
            Text(
                modifier = Modifier.fillMaxWidth(),
                text = stringResource(id = R.string.home_empty_search_subtitle),
                textAlign = TextAlign.Center,
