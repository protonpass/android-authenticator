...
include(":features:biometrics:activation")
include(":features:biometrics:authentication")
include(":features:biometrics:deactivation")
include(":features:biometrics:shared")
